...
const socials = [
  ...
  {
    name: "LinkedIn",
    href: "http://www.linkedin.com/in/abusaieed0",
    icon: FiLinkedin,
  },
  {
    name: "Facebook",
    href: "https://www.facebook.com/abu.saieed.90",
    icon: FiFacebook,
  },
];
    ...
    <footer className="border-t border-white/[0.06] bg-black/20 mt-24 pt-20 pb-10">
      <div className="container-main px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-20">
          ...
          {/* Column 2: Navigation */}
          <div className="flex flex-col gap-4">
            <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[var(--color-text-muted)]">
              Navigation
            </h4>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 text-sm text-[var(--color-text-secondary)]">
              <a
                href="mailto:abusaieed0@gmail.com"
                className="hover:text-[#00E5FF] transition-colors"
              >
                abusaieed0@gmail.com
              </a>
              <a
                href="tel:+8801719036590"
                className="text-[var(--color-text-muted)] hover:text-[#00E5FF] transition-colors"
              >
                +880 17190-36590
              </a>
            </div>
